...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Database.login_prompt'
        db.add_column(u'spinner_database', 'login_prompt',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Database.db_command'
        db.add_column(u'spinner_database', 'db_command',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Database.login_prompt'
        db.delete_column(u'spinner_database', 'login_prompt')

        # Deleting field 'Database.db_command'
        db.delete_column(u'spinner_database', 'db_command')
