...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Database.order'
        db.alter_column(u'spinner_database', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Database.order'
        db.alter_column(u'spinner_database', 'order', self.gf('django.db.models.fields.IntegerField')(default=1))
